<?php
	$conn=mysqli_connect('sophia.cs.hku.hk', 'h3537516', '19971010') or die('Error! first'.mysqli_error($conn));
			...
			while($row = mysqli_fetch_array($result)){
				if($_GET['friendname']==$row['name']){
					if ($row['starred'] == 'N'){
						...
						$query2 = "update friends set starred=\"Y\" where name="."\"".$_GET['friendname']."\"";
						...
						$query2 = "update friends set starred=\"N\" where name="."\"".$_GET['friendname']."\""; 
